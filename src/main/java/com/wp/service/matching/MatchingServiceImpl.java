...
public class MatchingServiceImpl implements MatchingService {
    ...
    @Transactional
    public boolean ProceedMatching(long bno, String sid) {
        ...
        entity.update(student, student.getNickname());
    ...
    public String ProceedPage(String sid, long bno){
        Matching entity=matchingRepository.findByBno(bno);
        if (entity==null||entity.getStudentForeignkey_accept().getSid().equals(null))return "errors/errorPage";
